...
const BOOKS = [
  { id: 'living', image: '/images/living_room.png', title: 'Living Room' },
  { id: 'kitchen', image: '/images/kitchen.png', title: 'Kitchen' },
  { id: 'bedroom', image: '/images/bedroom.png', title: 'Bedroom' },
  { id: 'washroom', image: '/images/washroom.png', title: 'Washroom' },
  { id: 'study', image: '/images/study.png', title: 'Study Room' },
  { id: 'elevations', image: '/images/elevations.png', title: 'Elevations' },
];
    ...
    <div onClick={handleSkip} className="sp-root" style={{ opacity: phase === 'fadeout' ? 0 : 1 }}>
      ...
      {phase === 'intro' && (
        <div className={`sp-intro ${introVis ? 'vis' : ''}`}>
          <h1>6 Books for <span>Interiors/Exteriors</span></h1>
        </div>
      )}
      ...
      {phase === 'folder' && (
        <div className="sp-folder-wrap">
          ...
          <div className={`sf-title ${folderClosed ? 'vis' : ''}`}>
            <h3>6 Books on Residential Design</h3>
          </div>
        </div>
      )}
    </div>
